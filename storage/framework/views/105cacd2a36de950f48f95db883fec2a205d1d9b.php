...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/salone.css')); ?>">
    <script src="<?php echo e(asset('js/script_salone.js')); ?>"></script>
...
<meta name="_token" data-token="<?php echo e(csrf_token()); ?>">
    ...
    <header>
        ...
        <div>
            ...
            <div class="title">
                ...
                <p data-cf="<?php echo e($userInfo[0]->Iva); ?>">Ciao, <?php echo e($userInfo[0]->nome); ?></p>
            </div>
    
            <div class="menu">
                <div class="<?php if(Request::get('page') != 'prenotazioni' && Request::get('page') != ''): ?> <?php echo e(''); ?> <?php else: ?> <?php echo e('sel'); ?>  <?php endif; ?>" data-page="prenotazioni">
                    <i class="fas fa-shopping-cart"></i>
                    <a>Prenotazioni</a>
                </div>
                <div class="<?php if(Request::get('page') != 'servizi'): ?> <?php echo e(''); ?> <?php else: ?> <?php echo e('sel'); ?> <?php endif; ?>" data-page="servizi">
    ...
    <div class="body emptyImg <?php if(Request::get('page') != 'prenotazioni' && Request::get('page') != ''): ?> <?php echo e('hidden'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>" id="body_prenotazioni" data-page="prenotazioni">
    ...
    <div class="body <?php if(Request::get('page') != 'servizi'): ?> <?php echo e('hidden'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>" id="body_servizi" data-page="servizi">
        <div class="header_mobile">
            <i class="fas fa-bars"></i>
        </div>
        ...
        <div class="all">
            ...
            <div class="addServizio addAppuntamento">
                <div data-cf="<?php echo e($userInfo[0]->Iva); ?>">
...
</html><?php /**PATH /Users/matte1/Desktop/homework/resources/views/salone.blade.php ENDPATH**/ ?>