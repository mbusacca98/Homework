...
<body>
    ...
    <header>
        ...
        <div>
            ...
            <div class="title">
                ...
                <p data-cf="<?php echo e($userInfo[0]->CF); ?>">Ciao, <?php echo e($userInfo[0]->Nome); ?></p>
            </div>
            ...
            <div class="menu">
                ...
                <div class="<?php if(Request::get('page') != 'saloni'): ?> <?php echo e(''); ?> <?php else: ?> <?php echo e('sel'); ?> <?php endif; ?>" data-page="saloni">
    ...
    <div class="body <?php if(Request::get('page') != 'saloni'): ?> <?php echo e('hidden'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>" id="body_saloni" data-page="saloni">
    ...
    <div class="body emptyImg <?php if(Request::get('page') != 'prenotazioni' && Request::get('page') != ''): ?> <?php echo e('hidden'); ?> <?php else: ?> <?php echo e(''); ?> <?php endif; ?>" id="body_prenotazioni" data-page="prenotazioni">
        ...
        <div class="all">
            ...
            <div class="addAppuntamento">
                <div data-cf="<?php echo e($userInfo[0]->CF); ?>">
...
</html><?php /**PATH /Users/matte1/Desktop/homework/resources/views/user.blade.php ENDPATH**/ ?>